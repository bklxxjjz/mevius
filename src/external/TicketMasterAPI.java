...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "5uga8IjtGkqLzpXNJCXyHyh4BmUmhwd4";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			/* Tell what HTTP method to use. GET by default. The HttpUrlConnection class is
			 * used for all types of requests: GET, POST, HEAD, OPTIONS, PUT, DELETE, TRACE. */
			...
			/* Close the BufferedReader after reading the input stream / response data. */
			reader.close();
